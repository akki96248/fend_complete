...
export default function Singup(props) {
  ...
  const Navigate=useNavigate();
    ...
    const handleSubmit = async (e) => {
        ...
        adduser(credentials.first_name,credentials.last_name,credentials.email,credentials.mobile,credentials.password);
        setCredentials({first_name: "",last_name:"", email: "",mobile:"", password: ""}) 
